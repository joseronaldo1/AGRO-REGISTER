...
import Formulariolote from '../organismos/FormProgramacionEstado';


function ModalEstadoProgramacion({ titulo, mostrar, cerrarModal, handleSubmit, actionLabel, initialData, mode }) {
  useEffect(() => {
    if (!mostrar) {
